...
def exampleAllHosts( vlan ):
    ...
    net = Mininet( host=host, topo=topo, link=link, ipBase='10.0.0.0/8')
    c0 = net.addController(name='c0',controller=RemoteController,ip='172.17.0.2',protocol='tcp', port=6633)
    c1 = net.addController(name='c1',controller=RemoteController,ip='172.17.0.4',protocol='tcp', port=6633)
    net.start()
